...
/**
 * MyFunctions Includes functions to signal an application, take passed arguments,
 * and invoke a method to check for month name based on supplied number
 * 
